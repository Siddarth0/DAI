...
def notice_detail(request, id):
    ...
    return render(request, 'dashboard/notice_detail.html', {'notice': notice})
...
def service_detail(request, id):
    ...
    return render(request, 'dashboard/service_detail.html', {'service': service})
...
def cms_page_detail(request, slug):
    ...
    return render(request, 'dashboard/cms/page_detail.html', {'page': page})
